        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-20 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="relative group" data-animate="slide-in-up" style={{transitionDelay: '0.5s'}}>
              ...
              <div className="relative bg-white p-8 rounded-2xl shadow-lg border border-gray-200 group-hover:shadow-2xl transition-shadow duration-300">
                <div className="flex items-center justify-center h-16 w-16 rounded-2xl bg-gradient-to-br from-gray-500 to-gray-600 text-white shadow-lg">
                  <Info className="w-8 h-8" />
                </div>
                <h3 className="mt-6 text-5xl font-extrabold text-gray-700">Zero</h3>
                <p className="mt-3 text-xl font-bold text-gray-900">Transparency</p>
          ...
          <div className="mt-20 max-w-2xl mx-auto text-center" data-animate="fade-in">
            <div className="relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            <span className="inline-block px-4 py-2 bg-green-100 text-green-700 rounded-full text-sm font-semibold mb-4" data-animate="fade-in">
              The Healthclarified Difference
            </span>
            <h2 className="text-3xl sm:text-5xl font-bold text-gray-900 leading-tight" data-animate="slide-in-up">
              ...
              <div className="space-y-16 flex flex-col justify-center min-h-[500px]">
                <div ref={el => scrollyTextRefs.current[0] = el} className="scrolly-text p-8 rounded-2xl" data-step="1">
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-red-100 rounded-full mb-4">
                    ...
                    <span className="text-xs font-semibold text-red-700">PREVENT DENIALS</span>
                  </div>
                ...
                <div ref={el => scrollyTextRefs.current[1] = el} className="scrolly-text p-8 rounded-2xl" data-step="2">
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-100 rounded-full mb-4">
                    <Zap className="w-4 h-4 text-blue-600" />
                    <span className="text-xs font-semibold text-blue-700">AUTOMATION</span>
                  </div>
                ...
                <div ref={el => scrollyTextRefs.current[2] = el} className="scrolly-text p-8 rounded-2xl" data-step="3">
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-green-100 rounded-full mb-4">
                    <Info className="w-4 h-4 text-green-600" />
                    <span className="text-xs font-semibold text-green-700">TRANSPARENCY</span>
                  </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="mt-20 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group relative" data-animate="slide-in-up" style={{transitionDelay: '0.3s'}}>
              <div className="absolute inset-0 bg-gradient-to-br from-blue-600 to-blue-400 rounded-2xl transform group-hover:scale-105 transition-transform duration-300 opacity-0 group-hover:opacity-100"></div>
            ...
            <div className="group relative" data-animate="slide-in-up" style={{transitionDelay: '0.4s'}}>
              <div className="absolute inset-0 bg-gradient-to-br from-green-600 to-green-400 rounded-2xl transform group-hover:scale-105 transition-transform duration-300 opacity-0 group-hover:opacity-100"></div>
              <div className="relative bg-white p-8 rounded-2xl shadow-lg border-2 border-gray-100 group-hover:border-green-200 transition-all duration-300 h-full">
                ...
                <div className="mt-6 pt-6 border-t border-gray-100">
                  <div className="flex items-center gap-2 text-sm font-semibold text-green-600 opacity-0 group-hover:opacity-100 transition-opacity">
                    <span>Learn more</span>
                    <svg className="w-4 h-4 transform group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
            ...
            <div className="group relative" data-animate="slide-in-up" style={{transitionDelay: '0.5s'}}>
              <div className="absolute inset-0 bg-gradient-to-br from-orange-600 to-orange-400 rounded-2xl transform group-hover:scale-105 transition-transform duration-300 opacity-0 group-hover:opacity-100"></div>
              <div className="relative bg-white p-8 rounded-2xl shadow-lg border-2 border-gray-100 group-hover:border-orange-200 transition-all duration-300 h-full">
                ...
                <div className="mt-6 pt-6 border-t border-gray-100">
                  <div className="flex items-center gap-2 text-sm font-semibold text-orange-600 opacity-0 group-hover:opacity-100 transition-opacity">
                    <span>Learn more</span>
                    <svg className="w-4 h-4 transform group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
          ...
          <div className="mt-16 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="group" data-animate="slide-in-left">
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl shadow-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 h-full">
                ...
                <p className="text-xl italic text-white leading-relaxed mb-6">"Healthclarified reduced our denial rate by 22% in just 90 days. It's become the brain of our entire financial operations."</p>
            ...
            <div className="bg-gradient-to-br from-white to-blue-50 p-12 sm:p-16 rounded-3xl shadow-2xl border border-blue-100" data-animate="fade-in">
              <div className="text-center">
                ...
                <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
                  <a href="#" className="group w-full sm:w-auto text-lg font-semibold text-white bg-blue-600 hover:bg-blue-700 px-10 py-4 rounded-xl transition-all shadow-lg hover:shadow-2xl inline-flex items-center justify-center gap-3 transform hover:-translate-y-1">
